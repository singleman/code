...
#define MAXLINE 4096	/* max line lenth */
...
#define DIR_MODE  (FIEL_MODE | S_IXUSR | S_IXGRP | S_IXOTH)
...
int	recv_fd(int,  ssize_t (*func)(int, const void *,size_t));/*Figure17.14*/
...
void	TELL_WAIT(void);	/* parent/child from Section8.9 */
